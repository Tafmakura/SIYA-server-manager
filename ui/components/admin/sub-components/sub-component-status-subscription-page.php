...
function arsol_sub_component_status_subscription_page($server_post_id){
    ...
    <p><?php echo esc_html__("<b>Important:</b> A Server status represents the provision status of the server and not its current power status.", 'arsol-server-manager'); ?></p>
