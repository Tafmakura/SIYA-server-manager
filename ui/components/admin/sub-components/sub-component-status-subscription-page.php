...
function arsol_sub_component_status_subscription_page($server_post_id){
    ...
    <p><b><?php echo esc_html__("Important:", 'arsol-server-manager'); ?></b> <?php echo esc_html__("A Server status represents the provision status of the server and not its current power state.", 'arsol-server-manager'); ?></p>
