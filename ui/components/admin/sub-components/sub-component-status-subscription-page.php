...
function arsol_sub_component_status_subscription_page($server_post_id){
    ...
    <p><b><?php echo esc_html__("A Server status represents the provisioning status of a server and not its current power state.", 'arsol-server-manager'); ?></p>
    <p class="form-field form-field-wide"><b>Server status: </b><a href="<?php echo esc_url(get_edit_post_link($server_post_id)); ?>">ARSOL<?php echo $subscription_id; ?> →</a></p>
