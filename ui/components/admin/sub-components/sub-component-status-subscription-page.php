...
function arsol_sub_component_status_subscription_page($server_post_id){
    ...
    <p><strong>Important: </strong><?php echo esc_html__("A Server status represents the provisioning status of a server and not its current power state.", 'arsol-server-manager'); ?></p>
