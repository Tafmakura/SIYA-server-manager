...
function arsol_sub_component_status_subscription_page($server_post_id){
    ...
    <p><strong>Important: </strong><?php echo esc_html__("A Server state represents the provisioning state of a server and not its current power state.", 'arsol-server-manager'); ?></p>
