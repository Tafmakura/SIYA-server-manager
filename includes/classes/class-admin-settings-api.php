...
class API  {
    ...
    public function runcloud_api_key_field() {
        ...
        ?>
        <textarea name="runcloud_api_key" style="width: 100%; max-width: 400px; height: 116px; resize: none; overflow: auto;"><?php echo esc_textarea($api_key); ?></textarea>
        <?php
    }
    ...
    public function hetzner_api_key_field() {
        ...
        ?>
        <textarea name="hetzner_api_key" style="width: 100%; max-width: 400px; height: 116px; resize: none; overflow: auto;"><?php echo esc_textarea($api_key); ?></textarea>
        <?php
    }
    ...
    public function digitalocean_api_key_field() {
        ...
        ?>
        <textarea name="digitalocean_api_key" style="width: 100%; max-width: 400px; height: 116px; resize: none; overflow: auto;"><?php echo esc_textarea($api_key); ?></textarea>
        <?php
    }
    ...
    public function vultr_api_key_field() {
        ...
        ?>
        <textarea name="vultr_api_key" style="width: 100%; max-width: 400px; height: 116px; resize: none; overflow: auto;"><?php echo esc_textarea($api_key); ?></textarea>
        <?php
    }
}
