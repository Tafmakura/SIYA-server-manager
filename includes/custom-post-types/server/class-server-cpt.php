...
class ServerPost {
    ...
    private function load_meta_data() {
        ...
        $this->server_provisioned_name = get_post_meta($this->post_id, self::META_PREFIX . 'provisioned_name', true);
        $this->server_provisioned_status = get_post_meta($this->post_id, self::META_PREFIX . 'provisioned_status', true);
