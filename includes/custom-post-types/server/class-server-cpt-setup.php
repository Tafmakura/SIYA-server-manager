        ...
        if ($column === 'details') {
            ...
            if ($subscription_id) {
                ...
                if ($subscription) {
                    ...
                    echo sprintf(
                        __('This server was assigned server post id:%d and is associated with subscription <strong><a href="%s">#%s</a></strong> belonging to <a href="%s">%s</a>', 'your-text-domain'),
                        $post_id,
