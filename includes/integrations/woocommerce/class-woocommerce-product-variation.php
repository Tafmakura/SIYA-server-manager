    ...
    public function add_custom_fields($loop, $variation_data, $variation) {
      ...
      // $hidden_class = '';
        woocommerce_wp_text_input([
            ...
            'wrapper_class' => "form-row form-row-first show_if_arsol_server hhide_if_arsol_sites_server",
            'desc_tip'    => true,
        ...
        woocommerce_wp_text_input([
            ...
            'wrapper_class' => "form-row form-row-last show_if_arsol_server hhide_if_arsol_sites_server",
            'desc_tip'    => true,
