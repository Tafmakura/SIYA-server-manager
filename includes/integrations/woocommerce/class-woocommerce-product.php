...
class Product {
    ...
    public function save_arsol_server_settings_tab_content($post_id) {
        ...
        $arsol_wordpress_ecommerce_server = isset($_POST['_arsol_ecommerce']) && ($_POST['_arsol_wordpress_server'] === 'yes') ? 'yes' : 'no';
        ...
        update_post_meta($post_id, '_arsol_wordpress_ecommerce', $arsol_wordpress_ecommerce_server);
